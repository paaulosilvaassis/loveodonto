...
export const LIFECYCLE_ACTIONS = Object.freeze({
  ...
  REPLACE_REVOKED_SIGNING_ACCESS: 'REPLACE_REVOKED_SIGNING_ACCESS',
});
...
export const LIFECYCLE_ACTION_WRITER_IMPLEMENTED = Object.freeze({
  ...
  [LIFECYCLE_ACTIONS.REPLACE_REVOKED_SIGNING_ACCESS]: true,
});
...
export const ROTATION_RACE = 'ROTATION_RACE';
export const ROTATE_NOT_ALLOWED = 'ROTATE_NOT_ALLOWED';
export const RESEND_NOT_ALLOWED = 'RESEND_NOT_ALLOWED';
export const ACCESS_REPLACEMENT_NOT_ALLOWED = 'ACCESS_REPLACEMENT_NOT_ALLOWED';
export const SIGNING_ACCESS_NOT_REPLACEABLE = 'SIGNING_ACCESS_NOT_REPLACEABLE';
export const SIGNING_PARTY_ALREADY_SIGNED = 'SIGNING_PARTY_ALREADY_SIGNED';
...
export const LIFECYCLE_AUDIT_EVENTS = Object.freeze({
  ...
  SIGN_LINK_ROTATED: 'SIGN_LINK_ROTATED',
  SIGN_LINK_EXPIRED: 'SIGN_LINK_EXPIRED',
  SIGN_INVITE_RESENT: 'SIGN_INVITE_RESENT',
  SIGNING_ACCESS_REPLACED: 'SIGNING_ACCESS_REPLACED',
});
