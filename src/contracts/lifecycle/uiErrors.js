...
const MESSAGES = Object.freeze({
  ...
  [ACCESS_REPLACEMENT_NOT_ALLOWED]: 'Você não tem permissão para gerar um novo acesso após revogação.',
  [SIGNING_ACCESS_NOT_REPLACEABLE]: 'Não há acesso revogado elegível para substituição.',
  [SIGNING_PARTY_ALREADY_SIGNED]: 'Este signatário já concluiu a assinatura.',
